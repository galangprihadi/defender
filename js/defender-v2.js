...
class Defender {
    ...
    loadGame() {
        ...
        this.eGameInfo.innerHTML = `${this.gameData.gameInfo}<button class="left">X</button>`;
    ...
    loadQuestion() {
        ...
        const clueText = this.gameData.quest[this.questNum][2];
